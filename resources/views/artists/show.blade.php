<x-app-layout>
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="h-48 bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-500 relative">
            ...
            <div class="px-6 pb-8 relative">
                <!-- Affichage principal de l'artiste -->
                <div class="flex flex-col md:flex-row gap-8 -mt-16 relative z-10 items-center md:items-start">
                    <div class="relative overflow-hidden rounded-full border-4 border-white shadow-md h-48 w-48 mx-auto md:mx-0">
                    ...
                    <div class="flex-grow mt-6 md:mt-0">
                        ...
                        <div class="space-y-6">
                            ...
                            @if($artist->description)
                                <div class="mt-4">
                                    <h3 class="text-lg font-medium text-gray-900 mb-2">Biographie</h3>
                ...
                <div class="mt-12">
                    <h2 class="text-xl font-semibold text-gray-900 mb-6 flex items-center">
                        ...
                        <span class="ml-2 text-sm bg-indigo-100 text-indigo-800 py-0.5 px-2 rounded-full">
                            {{ $artist->directedMovies->count() }}
                        </span>
                    </h2>

                    @if($artist->directedMovies->isNotEmpty())
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            @foreach($artist->directedMovies as $movie)
                                <div class="group bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition duration-300 overflow-hidden">
                                    ...
                                    <div class="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-red-500 to-orange-600"></div>

                                    <div class="p-4 pl-6">
                                        <div class="flex items-start justify-between">
                                            <div>
                                                <a href="{{ route('film.show', $movie->id) }}" class="text-lg font-semibold text-gray-900 group-hover:text-indigo-700 transition-colors">
                                                    {{ $movie->title }}
                                                </a>

                                                <div class="mt-2">
                                                    <!-- Badge de l'année -->
                                                    <div class="inline-flex items-center px-2.5 py-0.5 rounded-full bg-blue-50 text-blue-700 text-sm font-medium">
                                                        {{ $movie->year }}
                                                    </div>
                                                </div>
                                            ...
                                            <a href="{{ route('film.show', $movie->id) }}" class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-white border border-gray-200 text-indigo-600 hover:bg-indigo-50 hover:border-indigo-300 transition-colors">
                                    ...
                                    <div class="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-red-500 to-orange-600 transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left duration-300"></div>
                                </div>
                            @endforeach
                        </div>
                    @else
                        <div class="bg-white rounded-xl p-6 text-center border border-dashed border-gray-200">
                            ...
                            <p class="text-gray-500 mb-3">Aucun film réalisé par cet artiste</p>
                        </div>
                    @endif
                </div>
