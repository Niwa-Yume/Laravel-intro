<x-app-layout>
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
        <form action="{{ route('room.store') }}" method="POST" class="space-y-6">
            ...
            <!-- Nom de la salle -->
            <div>
                <label for="name" class="block text-sm font-medium text-gray-700 mb-1">Nom de la salle</label>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700">
                            <p>Vous ajoutez une salle au cinéma "{{ $cinema->name }}".</p>
                        </div>
                    </div>
                </div>
            </div>
