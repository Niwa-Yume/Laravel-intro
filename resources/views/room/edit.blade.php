<x-app-layout>
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
        <form action="{{ route('room.update', $room->id) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700">
                            <p>Vous modifiez une salle du cinéma "{{ $room->cinema->name }}".</p>
                        </div>
                    </div>
                </div>
            </div>
